    ...
    <div>
      ...
      <div className="container-fluid h-100 w-100 bg-body-secondary pb-5 mt-5">
        ...
        <h4 className="pt-5  text-center text-dark">
          ...
          this Privacy Policy have the same meaning as in our Terms and
          Conditions.
        </h4>
      ...
      <div className="container">
        <div className="row justify-content-center bg-green-1 text-light">
          <div className="col-md-10">
            <h4 className="text-warning text-center fw-bold mt-3">1. Introduction</h4>
            <p className="text-dark">
              Sarvamangala Finance (“us”, “we”, or “our”) operates at
              https://sarvamangalafinance.in/(hereinafter referred to as “Service”).
              Our Privacy Policy governs your visit to
              https://sarvamangalafinance.in/ and explains how we collect,
              ...
              Policy have the same meaning as in our Terms and Conditions. Our
              Terms and Conditions (“Terms”) govern all use of our Service and
              together with the Privacy Policy constitute your agreement with us
              (“Agreement”).
            </p>
            <h4 className="text-warning text-center fw-bold text-da">2. Definitions</h4>
            <p className="text-dark">
              SERVICE means the https://sarvamangalafinance.in/ website operated by
              Sarvamangala Finance. PERSONAL DATA means data about a living
            ...
            <h4 className="text-warning text-center fw-bold">3. Information Collection and Use</h4>
            <p className="text-dark">
              We collect several different types of information for various
              purposes to provide and improve our Service to you.
            </p>
            <h4 className="text-warning text-center fw-bold">4. Types of Data Collected</h4>
            <p className="text-dark">
              ...
              other information that may be of interest to you. You may opt out
              ...
              or when you access the Service by or through any device (“Usage
              ...
              Service, and to improve and customize our Service. You can enable
              or disable location services when you use our Service at any time
              by way of your device settings. Tracking Cookies Data We use
              cookies and similar tracking technologies to track the activity on
              our Service and we hold certain information. Cookies are files
              ...
              birth, passport details, citizenship, registration at the place of
            ...
            <h4 className="text-warning text-center fw-bold">5. Use of Data</h4>
            <p className="text-dark">
              Sarvamangala Finance uses the collected data for various purposes:
              0.1. to provide and maintain our Service; 0.2. to notify you about
              changes to our Service; 0.3. to allow you to participate in
              interactive features of our Service when you choose to do so; 0.4.
              to provide customer support; 0.5. to gather analysis or valuable
              information so that we can improve our Service; 0.6. to monitor
              the usage of our Service; 0.7. to detect, prevent, and address
              technical issues; 0.8. to fulfill any other purpose for which you
              provide it; 0.9. to carry out our obligations and enforce our
              ...
              notices about your account and/or subscription, including
            ...
            <h4 className="text-warning text-center fw-bold">6. Retention of Data</h4>
            <p className="text-dark">
            ...
            <h4 className="text-warning text-center fw-bold">7. Transfer of Data</h4>
            <p className="text-dark">
              ...
              Data, to No. 265, 2nd Floor, GST Road, Chromepet, Chennai – 600044
              ...
              to that transfer. Sarvamangala Finance will take all the steps
            ...
            <h4 className="text-warning text-center fw-bold">8. Disclosure of Data</h4>
            <p className="text-dark">
            ...
            <h4 className="text-warning text-center fw-bold">9. Security of Data</h4>
            <p className="text-dark">
            ...
            <h4 className="text-warning text-center fw-bold">
              10. Your Data Protection Rights Under the General Data Protection
              Regulation (GDPR)
            </h4>
            <p className="text-dark">
              ...
              you wish to be informed what Personal Data we hold about you and
              if you want it to be removed from our systems, please email us at
              info@sarvamangalafinance.in. In certain circumstances, you have the
              following data protection rights: 0.1. the right to access, update
              or delete the information we have on you; 0.2. the right of
              rectification. You have the right to have your information
              rectified if that information is inaccurate or incomplete; 0.3.
              the right to object. You have the right to object to our
              processing of your Personal Data; 0.4. the right of restriction.
              You have the right to request that we restrict the processing of
              your personal information; 0.5. the right to data portability. You
              have the right to be provided with a copy of your Personal Data in
              a structured, machine-readable, and commonly used format; 0.6. the
              right to withdraw consent. You also have the right to withdraw
              your consent at any time when we rely on your consent to process
              ...
              necessary data. You have the right to complain to a Data
            ...
            <p className="text-dark">
              ...
              page of our website; 0.3. users will be notified of any privacy
              policy changes on our Privacy Policy Page; 0.4. users are able to
              change their personal information by emailing us at
              info@sarvamangalafinance.in. Our Policy on “Do Not Track” Signals: We
            ...
            <p className="text-dark">
              ...
              make certain requests and ask us: 0.1. What personal information
              do we have about you? If you make this request, we will return to
              you: 0.0.1. The categories of personal information we have
              collected about you. 0.0.2. The categories of sources from which
              we collect your personal information. 0.0.3. The business or
              commercial purpose for collecting or selling your personal
              information. 0.0.4. The categories of third parties with whom we
              share personal information. 0.0.5. The specific pieces of personal
              ...
              other company we shared it with. Please note, that you are
              entitled to ask us to provide you with this information up to two
              times in a rolling twelve-month period. When you make this
              request, the information provided may be limited to the personal
              information we collected about you in the previous 12 months. 0.2.
              ...
              operate. 0.3. To stop selling your personal information. We don’t
              ...
              we will stop making such transfers. Please note, that if you ask
              us to delete or stop selling your data, it may impact your
              ...
              please send your request(s) by email: info@sarvamangalafinance.in.
            ...
            <h4 className="text-warning text-center fw-bold">13. Service Providers</h4>
            <p className="text-dark">
            ...
            <h4 className="text-warning text-center fw-bold">14. Analytics</h4>
            <p className="text-dark">
              We may use third-party Service Providers to monitor and analyze
              the use of our Service.
            </p>
            <h4 className="text-warning text-center fw-bold">15. CI/CD tools</h4>
            <p className="text-dark">
              We may use third-party Service Providers to automate the
              development process of our Service.
            </p>
            <h4 className="text-warning text-center fw-bold">16. Advertising</h4>
            <p className="text-dark">
              We may use third-party Service Providers to show advertisements to
              you to help support and maintain our Service.
            </p>
            <h4 className="text-warning text-center fw-bold">17. Behavioral Remarketing</h4>
            <p className="text-dark">
            ...
            <h4 className="text-warning text-center fw-bold">18. Links to Other Sites</h4>
            <p className="text-dark">
            ...
            <h4 className="text-warning text-center fw-bold">19. Children’s Privacy</h4>
            <p className="text-dark">
            ...
            <h4 className="text-warning text-center fw-bold">20. Changes to This Privacy Policy</h4>
            <p className="text-dark">
            ...
            <h4 className="text-warning text-center fw-bold">21. Contact Us</h4>
            <p className="text-dark">
              If you have any questions about this Privacy Policy, please
              contact us by email:{" "}
              <Link
                to={"mailto: info@sarvamangalafinance.in"}
                className="text-decoration-none concolor"
              >
                {" "}
                info@sarvamangalafinance.in
              </Link>
            </p>
          </div>
        </div>
