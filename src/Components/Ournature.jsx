                ...
                <div className='container'>
                    <div className='row py-5 paperrocket3'>
                        <div className='col-md-5 d-flex justify-content-center align-items-center'>
                            <div className='pt-2'>
                                <div className=''>
                                    <h4 className='nature-primary1 nature-1 heading4 text-dark' >Our Nature</h4>
                                    <h1 className='pt-2 fs-4 text-light nature-1 heading3'>“Your successful digital transformation is our first aspiration”</h1>
                        ...
                        <div className='col-md-7'>
                            <div className='row'>
                                <div className='d-flex pt-2 nature-2'>
                                    <div className='col-5'>
